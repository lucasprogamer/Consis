    <section class="row speakers">
        <div class="container">
            <div class="row sec_header_left">
                <h2>Palestrantes</h2>
                <p>Conheça quais os palestrantes que estarão no evento</p>
            </div>
                    ...
                    <ul class="slides">
                        <li>
                            ...
                            <div class="speakers_right">
                                <h4>Jean Carlo Nascimento - SUISSA</h4>
                                <h6>Técnologo em Análise de Sistemas pela UTF-PR &amp; Especialista em Desenvolvimento Web</h6>
